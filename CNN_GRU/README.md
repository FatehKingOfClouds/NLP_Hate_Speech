...
------------------------------------------
1. **CNN+GRU Baseline**
	1. Download the MUSE embeddings from the [MUSE github repository](https://github.com/facebookresearch/MUSE) and store them in the folder `CNN_GRU/muse_embeddings`, the files should have the extention `.vec`.
